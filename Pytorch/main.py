...
def main():
    ...
    parser.add_argument("--pp_graph_path", type=str, default="../dataset/pp_adj_3.npz")
    ...
    parser.add_argument('--trans', type=str, default="transd")
    ...
    model = CAPTOR(args, len(data.poi_idx) + 1, len(data.region_idx), data.eval_samples, 
